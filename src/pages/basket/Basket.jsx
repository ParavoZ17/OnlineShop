                ...
                <div className={styles.productInfo}>
                  <div className={styles.productTitle}>
                    ...
                    <button
                      ...
                      style={{ fontSize: "20px", border: "none",marginRight:'10px' }}
                    >
                      X
                    </button>
                  </div>
                  ...
                  {item.discont_price ? (
  <>
    <span className={styles.price}>${item.discont_price*item.quantity}</span>
    <span className={styles.discont_price}>${item.price}</span>
  </>
) : (
  <span className={styles.price}>${item.price}</span>
          ...
          <div className={styles.orderSending}>
            <div className={styles.orderSendingTitle}>
              <h3>Order details</h3>
            <p className={styles.quantityItem}>{summary.totalQuantity > 1 ? `${summary.totalQuantity} items `: `${summary.totalQuantity} item `}</p>
